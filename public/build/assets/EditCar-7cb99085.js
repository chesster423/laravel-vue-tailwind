...
const _sfc_main = {
  ...
  methods: {
    ...
    async findCarPersona() {
      await axios.get("../../../api/car_persona/" + this.id).then((response) => {
        this.car.persona = response.data;
      });
    },
    async submit() {
      await axios.post("../../../api/car/" + this.id, this.car).then((response) => {
        this.popToast({
          message: "Car saved!",
          timer: 5e3,
          icon: "success"
...
const EditCar_vue_vue_type_style_index_0_scoped_023c3f1c_lang = "";
const _withScopeId = (n) => (pushScopeId("data-v-023c3f1c"), n = n(), popScopeId(), n);
const _hoisted_1 = {
  id: "create-car",
  class: "bg-white p-3 dark:bg-slate-800 dark:text-gray-200"
};
const _hoisted_2 = { class: "container p-5" };
const _hoisted_3 = { class: "grid grid-cols-2 gap-10" };
...
const _hoisted_83 = {
  key: 0,
  class: "mb-6 mt-5 grid gap-6 md:grid-cols-2"
};
...
const _hoisted_93 = { class: "container p-5" };
      ...
      createBaseVNode("div", _hoisted_3, [
        ...
        createBaseVNode("div", null, [
          createVNode(_component_app_accordion, { class: "mb-8" }, {
            ...
            content: withCtx(() => [
              $data.car.persona ? (openBlock(), createElementBlock("div", _hoisted_83, [
                createBaseVNode("div", null, [
                  _hoisted_84,
                  withDirectives(createBaseVNode("select", {
...
const EditCar = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-023c3f1c"]]);
export {
  EditCar as default
};
